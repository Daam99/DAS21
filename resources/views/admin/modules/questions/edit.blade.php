            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        <form action="{{URL::to('/admin/questions')}}/{{$question->id}}" method="POST">
                            {{csrf_field()}}
                            {{ method_field('PUT')}}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="p-20">
                                        <div class="form-group m-b-20 {{$errors->has('statement') ? 'has-error' : ''}}">
                                            ...
                                            <input type="text" name="statement" class="form-control" id="statement" placeholder="Enter statement" @if (count($errors) > 0) value="{{ old('statement') }}" @else value="{{$question->statement}}" @endif >
