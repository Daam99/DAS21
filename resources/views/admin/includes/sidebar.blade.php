        ...
        <div id="sidebar-menu">
            <div class="user-details">
                ...
                <div class="text-center">
                    <img src="{{ asset('adminAssets/assets/images/users/avatar-128.png') }}" alt="" class="thumb-md img-circle">
                </div>
                <div class="user-info">
                    <div>
            ...
            <div class="dropdown" id="setting-dropdown">
                <ul class="dropdown-menu">
                    ...
                    <li><a href="javascript:void(0)"><form method="POST" action="{{ route('logout') }}">
                            @csrf
            ...
            <ul>
            	<li class="menu-title">Navigation</li>
                    <li><a href="{{route('admin/dashboard')}}"><i class="mdi mdi-view-dashboard"></i>Dashboard</a></li>
                </li>
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <!-- <li><a href="{{url('/admin/roles/create')}}">+Add new</a></li> -->
                        <li><a href="{{url('/admin/attempts')}}">View All</a></li>                   
                    </ul>
                </li>
                <li class="has_sub">
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{url('/admin/questions/create')}}">+Add new</a></li>
                        <li><a href="{{url('/admin/questions')}}">View All</a></li>                   
                    </ul>
                </li>
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{url('/admin/answers/create')}}">+Add new</a></li>
                        <li><a href="{{url('/admin/answers')}}">View All</a></li>                   
                    </ul>
                </li>
