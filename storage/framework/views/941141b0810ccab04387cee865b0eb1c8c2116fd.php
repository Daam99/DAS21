                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card-box">
                                    ...
                                    <form action="<?php echo e(URL::to('/admin/roles')); ?>" method="POST">
                                        <?php echo csrf_field(); ?> 
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="p-20">
                                                    <div class="form-group m-b-20 <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
                                                        ...
                                                        <input type="text" name="name" class="form-control" id="name" placeholder="Enter name" <?php if(count($errors) > 0): ?> value="<?php echo e(old('name')); ?>" <?php endif; ?>>
...
<?php endif; ?>
    ...
    <?php /**PATH C:\xampp\htdocs\DAS21\resources\views/admin/modules/roles/create.blade.php ENDPATH**/ ?>