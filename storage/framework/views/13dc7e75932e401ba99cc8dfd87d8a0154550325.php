    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="header-title m-t-0">Edit Answer</h4>

                        <form action="<?php echo e(URL::to('/admin/answers')); ?>/<?php echo e($answer->id); ?>" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="p-20">
                                        <div class="form-group m-b-20 <?php echo e($errors->has('number') ? 'has-error' : ''); ?>">
                                            ...
                                            <input type="text" name="number" class="form-control" id="number" placeholder="Enter Number" <?php if(count($errors) > 0): ?> value="<?php echo e(old('number')); ?>" <?php else: ?> value="<?php echo e($answer->number); ?>" <?php endif; ?> >
                                ...
                                <div class="col-md-6">
                                    <div class="p-20">
                                        <div class="form-group m-b-20 <?php echo e($errors->has('text') ? 'has-error' : ''); ?>">
                                            ...
                                            <input type="text" name="text" class="form-control" id="text" placeholder="Enter Text" <?php if(count($errors) > 0): ?> value="<?php echo e(old('text')); ?>" <?php else: ?> value="<?php echo e($answer->text); ?>" <?php endif; ?> >
                                ...
                                <div class="col-md-6">
                                    <div class="p-20">
                                        <div class="form-group m-b-20 <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
                                            ...
                                            <input type="name" name="name" class="form-control" id="name" placeholder="Enter Name" <?php if(count($errors) > 0): ?> value="<?php echo e(old('name')); ?>" <?php else: ?> value="<?php echo e($answer->name); ?>" <?php endif; ?> >
                            ...
                            <div class="form-group text-right m-b-0">
                                ...
                                <a href="<?php echo e(url('/admin/answers')); ?>" class="btn btn-default waves-effect m-l-5">
                                    Cancel 
                                </a>
                            </div>
                        </form>
...
<?php endif; ?>    
    ...
    <?php /**PATH C:\xampp\htdocs\DAS21\resources\views/admin/modules/answers/edit.blade.php ENDPATH**/ ?>